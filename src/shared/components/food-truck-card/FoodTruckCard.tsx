          ...
          <>
            ...
            <div className='flex flex-col'>
              <div className='flex items-center'>
                ...
                <span className='caption-m-11 text-grayscale-500 ml-[0.3rem]'>{props.data.averageRating}</span>
                <span className='caption-m-10 text-grayscale-300 ml-[0.2rem]'>({props.data.ratingCount})</span>
              </div>
              <span className='caption-m-11 text-grayscale-700 mb-[0.4rem] text-left'>{props.data.description}</span>
